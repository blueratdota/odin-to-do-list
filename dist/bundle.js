...
class entryFolder{
    ...
    constructEntry(data){
        ...
        date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(data.dueDate), "MM/dd/yyyy") //output
