...
class entryFolder{
    ...
    constructEntry(data){
        ...
        date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(data.dueDate, "MM/dd/yyyy") //output
...
// add to array
const newEntry1 = new _createFunctions__WEBPACK_IMPORTED_MODULE_1__.toDoEntry('sample 1','hidden details',new Date(2025, 1, 11),'low')
const newEntry2 = new _createFunctions__WEBPACK_IMPORTED_MODULE_1__.toDoEntry('sample 2','hidden details',new Date(2024, 10, 10),'medium')
const newEntry3 = new _createFunctions__WEBPACK_IMPORTED_MODULE_1__.toDoEntry('sample 3','hidden details',new Date(2023, 1, 15),'high')
...
finalizeEntry.addEventListener('click',function(){
    ...
    const newEntry = new _createFunctions__WEBPACK_IMPORTED_MODULE_1__.toDoEntry(_title,_details,new Date(_date[0], _date[1],_date[2]),_radio)
